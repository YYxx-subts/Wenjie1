...
echo '<input id="uname" data-x="30" data-y="290" data-w="320" data-h="46" type="text" autocomplete="username" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="next" aria-label="' . $wjPhUserAttr . '" style="position:absolute;left:0;top:0;width:320px;height:46px;padding:0 20px 0 70px;border:0;outline:none;background:transparent;font-size:15px;line-height:46px;color:#175DAA;" />';
echo '<input id="pass" data-x="30" data-y="350" data-w="320" data-h="46" type="password" autocomplete="current-password" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="done" aria-label="' . $wjPhPassAttr . '" style="position:absolute;left:0;top:0;width:320px;height:46px;padding:0 20px 0 70px;border:0;outline:none;background:transparent;font-size:15px;line-height:46px;color:#175DAA;" />';
// 登录按钮覆盖图片区域
