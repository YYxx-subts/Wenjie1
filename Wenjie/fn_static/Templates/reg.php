...
echo '<input id="nickname" data-x="30" data-y="261.5" data-w="320" data-h="46" type="text" maxlength="16" autocomplete="nickname" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="next" aria-label="昵称" style="position:absolute;left:0;top:0;width:320px;height:46px;padding:0 20px 0 70px;border:0;outline:none;background:transparent;font-size:15px;line-height:46px;color:#175DAA;" />';
// 账号：rect x=30 y=320, w=320 h=46
echo '<input id="uname" data-x="30" data-y="320" data-w="320" data-h="46" type="text" maxlength="15" autocomplete="username" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="next" aria-label="账号" style="position:absolute;left:0;top:0;width:320px;height:46px;padding:0 20px 0 70px;border:0;outline:none;background:transparent;font-size:15px;line-height:46px;color:#175DAA;" />';
// 密码：rect x=30 y=380, w=320 h=46
echo '<input id="pass" data-x="30" data-y="380" data-w="320" data-h="46" type="password" maxlength="16" autocomplete="new-password" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="next" aria-label="密码" style="position:absolute;left:0;top:0;width:320px;height:46px;padding:0 20px 0 70px;border:0;outline:none;background:transparent;font-size:15px;line-height:46px;color:#175DAA;" />';
// 确认密码：rect x=30 y=440, w=320 h=46
echo '<input id="repass" data-x="30" data-y="440" data-w="320" data-h="46" type="password" maxlength="16" autocomplete="new-password" autocapitalize="none" autocorrect="off" spellcheck="false" enterkeyhint="done" aria-label="确认密码" style="position:absolute;left:0;top:0;width:320px;height:46px;padding:0 20px 0 70px;border:0;outline:none;background:transparent;font-size:15px;line-height:46px;color:#175DAA;" />';
