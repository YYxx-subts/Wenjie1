...
<div class="mainbox max-width">
    ...
    <div class="roomnum" style="flex-shrink: 0"><img src="/Style/newimg/roomnum.png" style="width: auto!important;height: 0.6rem!important;"><span>房间号</span></div>
    <div class="room-num-input" id="numinput" style="flex-shrink: 0">
        <!-- iOS 中文环境 type=number 常仍出全键盘；tel + inputmode + pattern 才能稳定唤起数字键盘 -->
    ...
    <div class="room-in" id="loginroom" style="flex-shrink: 0"><img src="/Style/newimg/tologin.png"><span>登录</span></div>
        ...
        <div class="listroom">
            ...
            if (feiniao_ensure_user_room_history_table()) {
                ...
                <li class="roomrow" data-roomid="<?= (int)$card['roomid']; ?>">
                    <p class="room-avatar"><img src="<?= $avatarEsc; ?>" alt="" loading="eager" decoding="async" onerror="this.onerror=null;this.src='/Style/newimg/laba.png'"></p>
