...
?></li>
	...
	<div class="user_messages">
			<div>
				<input placeholder="位数/球号/金额" type="text" id="Message">
		...
		<div class="game-hd">
			<div class="menu">
				<ul>
					...
					<li class="gameli"><a href="javascript:;" data-t="3">猜三球总和</a></li>
					<li class="more-game">
						...
						<div class="sub-menu">
							...
							<a href="javascript:;" data-t="5">总和大小单双</a>
		...
		<div class="rightdiv">
			<!--div class="saidright">
				...
				<div class="ts"> 
					...
					<span class="neirongsaidl" style="background-color: #FFBBBB;">澳洲幸运10<br>期号:632246<br>已封盘，请耐心等待开奖！</span>
				</div>
			</div>
			<div class="saidright">
				<img src="/Public/images/gm.jpg">
				...
				<div class="ts"> 
					...
					<span class="neirongsaidl" style="background-color:#98E165;max-width: 100%">澳洲幸运10<br>期号:632246<br>已封盘，请耐心等待开奖！</span>
				</div>
			</div>
			<div class="saidright">
				<img src="/Public/images/gm.jpg">
				...
				<div class="ts"> 
					<b style=""></b>
					<span class="neirongsaidl" style="">澳洲幸运10<br>期号:632246<br>已封盘，请耐心等待开奖！</span>
				</div>
			</div>
			<div class="saidleft">
				<img src="/Public/images/gm.jpg">
				...
				<div class="tsf"> 
					<b></b>
					<span class="neirongsaid" style="">澳洲幸运10<br>期号:632246<br>已封盘，请耐心等待开奖！</span>
				</div>
			</div-->
		</div>
	</div>
...
?>>
						<img src="/Style/Home/images/pk10-logo.png" title="澳洲幸运10">
						<font>澳洲幸运10</font>
					</a>
				</li>
